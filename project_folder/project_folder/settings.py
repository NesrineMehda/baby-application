...
SECRET_KEY = 'django-insecure-y39v#oo##v_(kbhbq^y5q1j5zw_vjd85pt!sv#yqu=@3p00u+!'
...
INSTALLED_APPS = [
    ...
    #'autismChat.apps.AutismchatConfig',
    #'rest_framework.authtoken',
   # 'channels',
...
#ASGI_APPLICATION = 'project_folder.asgi.application'
